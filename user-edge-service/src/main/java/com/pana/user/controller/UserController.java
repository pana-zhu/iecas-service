package com.pana.user.controller;

import com.pana.thrift.message.*;
import com.pana.thrift.user.UserInfo;
import com.pana.thrift.user.dto.UserDTO;
import com.pana.user.redis.RedisClient;
import com.pana.user.response.LoginResponse;
import com.pana.user.response.Response;
import com.pana.user.thrift.ServiceProvider;
...
public class UserController {
    ...
    public Response login(@RequestParam("username")String username,
        ...
        //3. 缓存用户 ，因为保证每次都是无状态的所以不能存在session里 
